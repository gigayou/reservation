...
public class HosChoiceFragment extends StandardWithTobBarLayoutFragment {

    @BindView(R.id.hos_choice_recyclerview)
    RecyclerView mHosChoiceRecyclerView;
    @BindView(R.id.scrollview)
    NestedScrollView scrollView;
    @BindString(R.string.patient_hospital_choice_fragment_title)
    String title;
    ...
    protected int getLayoutId() {
        return R.layout.fragment_patient_hos_choice;
    }
    ...
    private void initListView() {
        mHosChoiceRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()){
            @Override
        ...
        adapter.setOnItemClickListener((itemView, pos) -> {
            ...
            NormalContainer.put(NormalContainer.SELECTED_HOSPITAL, hospital);
            startFragment(new DepChoiceFragment());
        });
        mHosChoiceRecyclerView.addItemDecoration(new DividerItemDecoration(getContext(),DividerItemDecoration.VERTICAL));
        mHosChoiceRecyclerView.setAdapter(adapter);
    }
