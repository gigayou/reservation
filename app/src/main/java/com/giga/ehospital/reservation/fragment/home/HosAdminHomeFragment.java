...
public class HosAdminHomeFragment extends BaseFragment {
    ...
    protected View onCreateView() {
        View root = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_hosadmin, null);
    ...
    private void initPagers() {
        ...
        ControllerClickHandler mHandler = new ControllerClickHandler() {
            ...
            public void startFragment(BaseFragment target) {
                HosAdminHomeFragment.this.startFragment(target);
            }

            @Override
            public void startFragmentAndDestroyCurrent(BaseFragment targetFragment) {
                HosAdminHomeFragment.this.startFragmentAndDestroyCurrent(targetFragment);
            }
        };
        mPages.put(Pager.HOME, new HosAdminHomeController(getContext(), mHandler));
        mPages.put(Pager.INFO, new HosAdminInfoController(getContext(), mHandler));
        mPages.put(Pager.MINE, new HosAdminMineController(getContext(), mHandler));
