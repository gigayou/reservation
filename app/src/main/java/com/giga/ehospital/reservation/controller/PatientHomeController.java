...
public class PatientHomeController extends QMUIWindowInsetLayout {
    ...
    UltraViewPager mPatientActivityUltraViewPager;
...
//            }
    ...
    private void initUltraViewPager() {
        mPatientActivityUltraViewPager.setScrollMode(UltraViewPager.ScrollMode.HORIZONTAL);
        mPatientActivityUltraViewPager.setAdapter(mUltraPagerAdapter);
        mPatientActivityUltraViewPager.setInfiniteLoop(true);
        mPatientActivityUltraViewPager.setAutoScroll(4000);
    }
