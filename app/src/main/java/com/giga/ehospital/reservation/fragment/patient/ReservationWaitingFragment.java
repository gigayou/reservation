...
public class ReservationWaitingFragment extends StandardWithTobBarLayoutFragment {

    @BindView(R.id.res_history_recyclerview)
    RecyclerView mPatientResHistoryRecyclerView;
    @BindView(R.id.scrollview)
    NestedScrollView scrollView;
    @BindString(R.string.patient_res_waiting_fragment_title)
    String title;
