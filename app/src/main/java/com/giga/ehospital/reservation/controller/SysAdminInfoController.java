...
public class SysAdminInfoController extends QMUIWindowInsetLayout {
...
//    QMUILinearLayout mQMUILinearLayout;
    ...
    public SysAdminInfoController(Context context, ControllerClickHandler mHandler) {
        super(context);
        this.mContext = context;
        this.mHandler = mHandler;
        LayoutInflater.from(context).inflate(R.layout.controller_sys_admin_info, this);
