...
import com.giga.ehospital.reservation.controller.SysAdminHomeController;
import com.giga.ehospital.reservation.controller.SysAdminInfoController;
import com.giga.ehospital.reservation.controller.SysAdminMineController;
...
public class SysAdminHomeFragment extends BaseFragment {
    ...
    protected View onCreateView() {
        View root = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_sysadmin, null);
    ...
    private void initPagers() {
        ...
        ControllerClickHandler mHandler = new ControllerClickHandler() {
            ...
            public void startFragment(BaseFragment target) {
                SysAdminHomeFragment.this.startFragment(target);
            }

            @Override
            public void startFragmentAndDestroyCurrent(BaseFragment targetFragment) {
                SysAdminHomeFragment.this.startFragmentAndDestroyCurrent(targetFragment);
            }
        };
        mPages.put(Pager.HOME, new SysAdminHomeController(getContext(), mHandler));
        mPages.put(Pager.INFO, new SysAdminInfoController(getContext(), mHandler));
        mPages.put(Pager.MINE, new SysAdminMineController(getContext(), mHandler));
