...
public class HosAdminInfoController extends QMUIWindowInsetLayout {
...
//    QMUILinearLayout mQMUILinearLayout;
    ...
    public HosAdminInfoController(Context context, ControllerClickHandler mHandler) {
        super(context);
        this.mContext = context;
        this.mHandler = mHandler;
        LayoutInflater.from(context).inflate(R.layout.controller_hos_admin_info, this);
