...
public class PatientInfoController extends QMUIWindowInsetLayout {
...
//    QMUILinearLayout mQMUILinearLayout;
    ...
    public PatientInfoController(Context context, ControllerClickHandler mHandler) {
        super(context);
        this.mContext = context;
        this.mHandler = mHandler;
        LayoutInflater.from(context).inflate(R.layout.controller_patient_info, this);
