...
public class SysAdminMineController extends QMUIWindowInsetLayout {
    ...
    public SysAdminMineController(Context context, ControllerClickHandler mHandler) {
        super(context);
        this.mContext = context;
        this.mHandler = mHandler;
        LayoutInflater.from(mContext).inflate(R.layout.controller_sys_admin_mine, this);
