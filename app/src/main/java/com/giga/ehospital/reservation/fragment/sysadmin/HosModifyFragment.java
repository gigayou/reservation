...
public class HosModifyFragment extends StandardWithTobBarLayoutFragment {
    ...
    @BindString(R.string.fragment_hos_modify_title)
    String title;
    ...
    private void initData() {
        ...
        Hospital hospital = (Hospital) arguments.get("hospital");
    ...
    @OnClick({R.id.tv_hos_manager, R.id.tv_hos_grade, R.id.tv_hos_invalid, R.id.tv_hos_addr, R.id.btn_save})
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_hos_manager:
                showHosManagerPickerView();
                break;
            case R.id.tv_hos_grade:
                showHosGradePickerView();
                break;
    ...
    private void showHosManagerPickerView() {

        OptionsPickerView pvOptions = new OptionsPickerBuilder(getContext(), new OnOptionsSelectListener() {
            @Override
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                String hosManager = hosManagerOptions.size() > 0 ?
                        hosManagerOptions.get(options1).getPickerViewText() : "";

                tvHosManager.setText(hosManager);
                sHosManagerIndex = options1;
                sHosManagerId = hosManagerOptions.get(sHosManagerIndex).getLoginId();
            }
        })
                .setTitleText("医院管理员选择")
                .setDividerColor(Color.BLACK)
                .setTextColorCenter(Color.BLACK) //设置选中项文字颜色
                .setContentTextSize(20)
                .build();

        pvOptions.setPicker(hosManagerOptions);
        pvOptions.show();
    }
    ...
    private void showHosGradePickerView() {

        OptionsPickerView pvOptions = new OptionsPickerBuilder(getContext(), new OnOptionsSelectListener() {
            @Override
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                String grade = gradeOptions.size() > 0 ?
                        gradeOptions.get(options1) : "";
                tvHosGrade.setText(grade);
                sHosGradeIndex = options1;
            }
        })
                .setTitleText("级别选择")
                .setDividerColor(Color.BLACK)
                ...
                .setContentTextSize(20)
                .build();
        pvOptions.setPicker(gradeOptions);
        pvOptions.show();
    }
